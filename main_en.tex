...
\section{Education}
\cventry{2022-2025}{PhD student}{University of Wuppertal}{Germany}{Research dynamics in high-energy physics (Research Training Group 2696, ``Transformations of science and technology since 1800: topics, processes, institutions
'') [\textit{on-going}]. $3^{1/2}$ years contract}{}
\cventry{2021-2022}{M.A}{Université Paris-Cité}{Paris}{History and Philosophy of Science [Class rank: 1st]}{Thesis : ``Too beautiful to be false, or too beautiful to be true? Searching supersymmetry at the \textit{Large Hadron Collider}''. Supervisors: Olivier Darrigol, Elisa Omodei.} 
\cventry{2014-2018}{Master 1}{Ecole Normale Supérieure de Cachan (Paris-Saclay)}{}{Fundamental Physics}{Theoretical and experimental physics. Full scholarship with civil-servant status.}
...
\cventry{Mar 2023 to Feb 2024}{Research Assistant \small{(part time)}}{Laboratoire de Sciences Cognitives et Psycholinguistique (LSCP - DEC - École Normale Supérieure)}{}{Paris}{Investigating correlations between speech heard and produced by young infants}
\cventry{Feb 2023--Jul 2023}{Visiting PhD student}{Medialab, Sciences Po Paris}{}{}{}
...
Influence of the nuclei distribution on weak interactions in core-collapse supernovae.  %Supervised by Micaela Oertel. 
% \begin{itemize}%
...
Sketching the History of Modern Cosmology.
...
\printbibliography[title={Pre-prints},keyword=preprints]
...
\cventry{Dec 2019 to Nov 2020}{President, Publication Manager}{Société de Production Le Média}{}{Montreuil}{Management of a production company with more than 12 full-time equivalent workers.
Marketing procedures optimization, development of revenue forecasting models and audience data analysis.}

\cventry{September 2018 to Sep 2020}{Journalist}{Le Média}{}{Montreuil}{Specializing in data journalism and book reviews \url{https://www.lemediatv.fr/auteurs/lucas-gautheron-9DAnWoo5Tlav1trWgg_Qlw/articles}.
}
...
\cventry{Jul 2013}{Developer}{Électricité réseau Distribution de France (ErDF)}{Annecy}{}{
\begin{itemize}%
...
\subsection{Computer}
\cvitem{Programming}{Python, C, C++, Fortran, Arduino}
\cvitem{Scientific software}{stan, numpy, scipy, cvxpy, scikit-learn, ROOT/RooFit}
\cvitem{Data}{Pandas, SQL, HDF}
